...
MySQL - 5.7.27 : Database - db_ponymall_ware
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_ponymall_ware` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `db_ponymall_ware`;

/*Table structure for table `tbl_undo_log` */

DROP TABLE IF EXISTS `tbl_undo_log`;

CREATE TABLE `tbl_undo_log` (
...
/*Table structure for table `tbl_ware_info` */

DROP TABLE IF EXISTS `tbl_ware_info`;

CREATE TABLE `tbl_ware_info` (
...
/*Data for the table `tbl_ware_info` */

/*Table structure for table `tbl_ware_order_task` */

DROP TABLE IF EXISTS `tbl_ware_order_task`;

CREATE TABLE `tbl_ware_order_task` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
/*Data for the table `tbl_ware_order_task` */

/*Table structure for table `tbl_ware_order_task_detail` */

DROP TABLE IF EXISTS `tbl_ware_order_task_detail`;

CREATE TABLE `tbl_ware_order_task_detail` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
/*Data for the table `tbl_ware_order_task_detail` */

/*Table structure for table `tbl_ware_sku` */

DROP TABLE IF EXISTS `tbl_ware_sku`;

CREATE TABLE `tbl_ware_sku` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `sku_id` bigint(20) DEFAULT NULL COMMENT 'sku_id',
  `ware_id` bigint(20) DEFAULT NULL COMMENT '仓库id',
...
/*Data for the table `tbl_ware_sku` */
