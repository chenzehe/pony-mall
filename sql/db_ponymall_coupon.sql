...
drop table if exists tbl_coupon_spu_category_relation;

drop table if exists tbl_coupon_spu_relation;

drop table if exists tbl_home_adv;

drop table if exists tbl_home_subject;

drop table if exists tbl_home_subject_spu;

drop table if exists tbl_member_price;

drop table if exists tbl_seckill_promotion;

drop table if exists tbl_seckill_session;

drop table if exists tbl_seckill_sku_notice;

drop table if exists tbl_seckill_sku_relation;

drop table if exists tbl_sku_full_reduction;

drop table if exists tbl_sku_ladder;

drop table if exists tbl_spu_bounds;
...
alter table tbl_coupon comment '优惠券信息';

/*==============================================================*/
/* Table: tbl_coupon_history                                    */
/*==============================================================*/
...
alter table tbl_coupon_history comment '优惠券领取历史记录';

/*==============================================================*/
/* Table: tbl_coupon_spu_category_relation                      */
/*==============================================================*/
create table tbl_coupon_spu_category_relation
(
   id                   bigint not null auto_increment comment 'id',
   coupon_id            bigint comment '优惠券id',
...
alter table tbl_coupon_spu_category_relation comment '优惠券分类关联';

/*==============================================================*/
/* Table: tbl_coupon_spu_relation                               */
/*==============================================================*/
create table tbl_coupon_spu_relation
(
   id                   bigint not null auto_increment comment 'id',
   coupon_id            bigint comment '优惠券id',
...
alter table tbl_coupon_spu_relation comment '优惠券与产品关联';

/*==============================================================*/
/* Table: tbl_home_adv                                          */
/*==============================================================*/
create table tbl_home_adv
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_home_adv comment '首页轮播广告';

/*==============================================================*/
/* Table: tbl_home_subject                                      */
/*==============================================================*/
create table tbl_home_subject
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_home_subject comment '首页专题表【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】';

/*==============================================================*/
/* Table: tbl_home_subject_spu                                  */
/*==============================================================*/
create table tbl_home_subject_spu
(
   id                   bigint not null auto_increment comment 'id',
   name                 varchar(200) comment '专题名字',
...
alter table tbl_home_subject_spu comment '专题商品';

/*==============================================================*/
/* Table: tbl_member_price                                      */
/*==============================================================*/
create table tbl_member_price
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_member_price comment '商品会员价格';

/*==============================================================*/
/* Table: tbl_seckill_promotion                                 */
/*==============================================================*/
create table tbl_seckill_promotion
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_seckill_promotion comment '秒杀活动';

/*==============================================================*/
/* Table: tbl_seckill_session                                   */
/*==============================================================*/
create table tbl_seckill_session
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_seckill_session comment '秒杀活动场次';

/*==============================================================*/
/* Table: tbl_seckill_sku_notice                                */
/*==============================================================*/
create table tbl_seckill_sku_notice
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_seckill_sku_notice comment '秒杀商品通知订阅';

/*==============================================================*/
/* Table: tbl_seckill_sku_relation                              */
/*==============================================================*/
create table tbl_seckill_sku_relation
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_seckill_sku_relation comment '秒杀活动商品关联';

/*==============================================================*/
/* Table: tbl_sku_full_reduction                                */
/*==============================================================*/
create table tbl_sku_full_reduction
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_sku_full_reduction comment '商品满减信息';

/*==============================================================*/
/* Table: tbl_sku_ladder                                        */
/*==============================================================*/
create table tbl_sku_ladder
(
   id                   bigint not null auto_increment comment 'id',
   sku_id               bigint comment 'spu_id',
...
alter table tbl_sku_ladder comment '商品阶梯价格';

/*==============================================================*/
/* Table: tbl_spu_bounds                                        */
/*==============================================================*/
create table tbl_spu_bounds
(
   id                   bigint not null auto_increment comment 'id',
   spu_id               bigint,
...
alter table tbl_spu_bounds comment '商品spu积分设置';
