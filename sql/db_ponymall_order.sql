...
drop table if exists tbl_order_operate_history;

drop table if exists tbl_order_return_apply;

drop table if exists tbl_order_return_reason;

drop table if exists tbl_order_setting;

drop table if exists tbl_payment_info;

drop table if exists tbl_refund_info;
...
alter table tbl_order comment '订单';
...
alter table tbl_order_item comment '订单项信息';

/*==============================================================*/
/* Table: tbl_order_operate_history                             */
/*==============================================================*/
create table tbl_order_operate_history
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_order_operate_history comment '订单操作历史记录';

/*==============================================================*/
/* Table: tbl_order_return_apply                                */
/*==============================================================*/
create table tbl_order_return_apply
(
   id                   bigint not null auto_increment comment 'id',
   order_id             bigint comment 'order_id',
...
alter table tbl_order_return_apply comment '订单退货申请';

/*==============================================================*/
/* Table: tbl_order_return_reason                               */
/*==============================================================*/
create table tbl_order_return_reason
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_order_return_reason comment '退货原因';

/*==============================================================*/
/* Table: tbl_order_setting                                     */
/*==============================================================*/
create table tbl_order_setting
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_order_setting comment '订单配置信息';

/*==============================================================*/
/* Table: tbl_payment_info                                      */
/*==============================================================*/
...
alter table tbl_payment_info comment '支付信息表';

/*==============================================================*/
/* Table: tbl_refund_info                                       */
/*==============================================================*/
create table tbl_refund_info
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_refund_info comment '退款信息';
