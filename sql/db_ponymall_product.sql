...
drop table if exists tbl_attr_attrgroup_relation;
...
drop table if exists tbl_category_brand_relation;

drop table if exists tbl_comment_replay;

drop table if exists tbl_product_attr_value;

drop table if exists tbl_sku_images;

drop table if exists tbl_sku_info;

drop table if exists tbl_sku_sale_attr_value;

drop table if exists tbl_spu_comment;

drop table if exists tbl_spu_images;

drop table if exists tbl_spu_info;

drop table if exists tbl_spu_info_desc;
...
alter table tbl_attr comment '商品属性';

/*==============================================================*/
/* Table: tbl_attr_attrgroup_relation                           */
/*==============================================================*/
create table tbl_attr_attrgroup_relation
(
...
alter table tbl_attr_attrgroup_relation comment '属性&属性分组关联';

/*==============================================================*/
/* Table: tbl_attr_group                                        */
/*==============================================================*/
...
alter table tbl_attr_group comment '属性分组';
...
alter table tbl_category comment '商品三级分类';

/*==============================================================*/
/* Table: tbl_category_brand_relation                           */
/*==============================================================*/
create table tbl_category_brand_relation
(
...
alter table tbl_category_brand_relation comment '品牌分类关联';

/*==============================================================*/
/* Table: tbl_comment_replay                                    */
/*==============================================================*/
create table tbl_comment_replay
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_comment_replay comment '商品评价回复关系';

/*==============================================================*/
/* Table: tbl_product_attr_value                                */
/*==============================================================*/
create table tbl_product_attr_value
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_product_attr_value comment 'spu属性值';

/*==============================================================*/
/* Table: tbl_sku_images                                        */
/*==============================================================*/
create table tbl_sku_images
(
   id                   bigint not null auto_increment comment 'id',
...
alter table tbl_sku_images comment 'sku图片';
...
alter table tbl_sku_info comment 'sku信息';

/*==============================================================*/
/* Table: tbl_sku_sale_attr_value                               */
/*==============================================================*/
...
alter table tbl_sku_sale_attr_value comment 'sku销售属性&值';

/*==============================================================*/
/* Table: tbl_spu_comment                                       */
/*==============================================================*/
create table tbl_spu_comment
(
   id                   bigint not null auto_increment comment 'id',
   sku_id               bigint comment 'sku_id',
...
alter table tbl_spu_comment comment '商品评价';

/*==============================================================*/
/* Table: tbl_spu_images                                        */
/*==============================================================*/
create table tbl_spu_images
(
   id                   bigint not null auto_increment comment 'id',
   spu_id               bigint comment 'spu_id',
...
alter table tbl_spu_images comment 'spu图片';

/*==============================================================*/
/* Table: tbl_spu_info                                          */
/*==============================================================*/
create table tbl_spu_info
(
...
alter table tbl_spu_info comment 'spu信息';

/*==============================================================*/
/* Table: tbl_spu_info_desc                                     */
/*==============================================================*/
create table tbl_spu_info_desc
(
...
alter table tbl_spu_info_desc comment 'spu信息介绍';
